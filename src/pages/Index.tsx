    ...
    <div className="min-h-screen bg-white">
      ...
      {!isLoggedIn ? (
        <div className="w-full">
          ...
          <section className="relative py-20 lg:py-32 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden">
            {/* Background Pattern */}
              ...
              <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                  ...
                  <Button 
                    variant="outline" 
                    size="lg" 
                    className="border-2 border-slate-300 hover:border-blue-500 hover:bg-blue-50 px-12 py-8 text-xl font-semibold rounded-2xl transition-all group bg-white/80"
                  >
          ...
          <section className="py-24 bg-slate-900 text-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-5xl mx-auto text-center">
                ...
                <p className="text-2xl text-slate-300 mb-16 leading-relaxed">Every day you wait is a day your competitors get ahead with better talent</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                  <div className="text-center space-y-6 bg-slate-800/50 p-8 rounded-2xl">
                    <div className="text-5xl font-bold text-red-400">47%</div>
                    <div className="text-slate-300 text-lg leading-relaxed">of startups fail due to bad hires</div>
                  </div>
                  <div className="text-center space-y-6 bg-slate-800/50 p-8 rounded-2xl">
                    <div className="text-5xl font-bold text-red-400">6 Weeks</div>
                    <div className="text-slate-300 text-lg leading-relaxed">average time to hire (killing velocity)</div>
                  </div>
                  <div className="text-center space-y-6 bg-slate-800/50 p-8 rounded-2xl">
                    <div className="text-5xl font-bold text-red-400">$240K</div>
                    <div className="text-slate-300 text-lg leading-relaxed">cost of every bad hire</div>
                  </div>
                  <div className="text-center space-y-6 bg-slate-800/50 p-8 rounded-2xl">
                    <div className="text-5xl font-bold text-red-400">89%</div>
                    <div className="text-slate-300 text-lg leading-relaxed">of founders hate their hiring process</div>
                  </div>
                </div>
                ...
                <div className="mt-16">
                  <Button 
                    size="lg" 
                    className="bg-white text-slate-900 hover:bg-slate-100 px-12 py-6 text-xl font-bold rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
                    onClick={() => setIsLoggedIn(true)}
                  >
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <div className="bg-white p-8 rounded-2xl shadow-lg">
                  <div className="text-4xl font-bold text-green-600 mb-4">10 Days</div>
                  <div className="text-slate-600">TechFlow hired their CTO in just 10 days instead of 8 weeks</div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg">
                  <div className="text-4xl font-bold text-blue-600 mb-4">15 Hires</div>
                  <div className="text-slate-600">DataSync built their entire tech team in 3 months</div>
                </div>
                <div className="bg-white p-8 rounded-2xl shadow-lg">
                  <div className="text-4xl font-bold text-purple-600 mb-4">$2M Raised</div>
