  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {!isLoggedIn ? (
        <>
          {/* Hero Section */}
          <section className="relative py-16 lg:py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-4xl mx-auto text-center">
                <Badge className="mb-6 bg-blue-100 text-blue-800 hover:bg-blue-200 px-4 py-2 text-sm">
            ...
            {activeTab === "dashboard" ? (
              ...
              <div className="max-w-7xl mx-auto space-y-16">
                <div className="text-center">
                  <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-slate-800">Your Hiring Command Center</h2>
